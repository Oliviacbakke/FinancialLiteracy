...
def test_first_last():
    ...
    expected = ['Aggie Kalinska', 'anonymous anonymous', 'Rachel Yang', 'Isaac Padilla', 'Jacob Brambila']
...
def test_travelled_south():
    ...
    expected = ['Rachel Yang (19.0725711419241°)', 'Jacob Brambila (5.693501°)']
...
def test_list_majors():
    ...
    expected = ['Aggie Kalinska (Biomedical Engineering): social systems debugging ', 'anonymous anonymous (): ', 'Rachel Yang (Biology ): interior design', 'Isaac Padilla (Mechanical Engineering): Space Travel', 'Jacob Brambila (Computer Science): Aerospace Engineering']
...
def test_cool_things():
    ...
    expected = [['Aggie Kalinska', '\tan algorithm analyzing social media ‘For You’ pages to determine the effect of social media use on the progression of individuals’ mental disorders', '\tanalyze different data (blood pressure, EEG signals, facial expressions) to quantify feelings and emotions'],
                ['anonymous anonymous', '\tChat GPT', '\tA persona website'],
                ['Rachel Yang'],
                ['Isaac Padilla', '\tA functioning computer using minecraft. A 3D geometry dash level (it is a 2D game).', '\tA bot to help me with stocks.'],
                ['Jacob Brambila', '\tPage Rank', '\tA personal, efficient large language model']]
...
def test_study_partners():
    ...
    expected = [['Aggie Kalinska mon 2-5 pm + after 6pm; tue and thu after 11am; wed after 3pm; fri after 2 pm; weekends anytime but 4-6pm', '\tplanning, organization, research, reflections & goals, task division, and project management', '\thow to translate ideas into code - how to break them down into codable steps; how to learn syntax effectively'],
    ['anonymous anonymous Afternoons after class', '\tMapping out a path to the solution ', '\tSystemically troubleshooting errors'],
    ['Isaac Padilla Mondays or Wednesdays after 3pm.', '\tI wouldn\'t say I\'m particularly good at anything specific, I\'ve really only ever coded using MATLAB.', '\tEverything I suppose, I will do my best to pull my weight too.'],
    ['Jacob Brambila After 2 PM and before 4 PM everyday except Fridays', '\tI am particularly good at framing problems and writing pseudocode', '\tI would like to master Python\'s syntax']]
...
def test_birthday_buddies():
    ...
    expected = {'09/28': ['Isaac Padilla', 'Jacob Brambila']}
