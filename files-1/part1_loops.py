"""
(Replace the header on this file with your own information.)

Original author: Olivia Bakke
Date: Feb 2
...
def add_row_sum(table):
    ...
    Returns:
        None
    """
    # Hint: make sure to calculate the row sum before you start changing the table!
