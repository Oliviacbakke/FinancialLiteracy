...
class Light:
    ...
    def can_go(self) -> bool:
        ...
        """
        # TODO: Implement me!
        if self.is_green and ((self.max_countdown - self.countdown) > 0):
            return True
        return False
...
class Car:
    ...
    def is_at_light(self) -> bool:
        ...
        # TODO: Implement me!
        return self.current_light is not None
    ...
    def timestep(self):
        ...
        if self.travel_time > 0:
            self.travel_time -= 1
        if self.travel_time == 0:
            if len(self.remaining_lights) == 0:
                assert 0 == 1
            next_light = self.remaining_lights.pop(0)
            self.current_light = next_light
            next_light.add_car_to_queue(self)
        return None
...
class Simulation:
    ...
    def waiting_car_count(self) -> int:
        ...
        count = 0
        for car in self.cars:
            if car.current_light is not None:
                count += 1
        return count
    ...
    def car_counts(self) -> list[int]:
        ...
        """
        # TODO: Implement me!
        lst = [0] * len(self.lights)
        for car in self.cars:
            if car.current_light is not None:
                index = car.current_light.id - 1
                lst[index] += 1
        return lst
    ...
    def timestep(self):
        ...
        for light in self.lights:
            light.timestep()
            while light.can_go() and light.queue_length() > 0:
